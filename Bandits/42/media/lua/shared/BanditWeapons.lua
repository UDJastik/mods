...
table.insert(BanditWeapons.Melee.DesperateCitizen, "Base.SpearShort")
...
table.insert(BanditWeapons.Melee.DesperateCitizen, "Base.IceHockeyStick")
...
table.insert(BanditWeapons.Melee.DesperateCitizen, "Base.GuitarElectric")
...
table.insert(BanditWeapons.Melee.Psychopath, "Base.Plank_Nails")
...
table.insert(BanditWeapons.Melee.Prepper, "Base.SpearShort")
...
table.insert(BanditWeapons.Melee.Biker, "Base.BaseballBat_Nails")
...
table.insert(BanditWeapons.Melee.DoomRider, "Base.BaseballBat_Nails")
